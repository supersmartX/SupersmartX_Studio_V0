...
export function Footer({ showShortcuts = true }: { showShortcuts?: boolean }) {
  return (
    <footer className="hidden md:flex h-7 border-t border-border-subtle bg-surface items-center px-4 justify-between text-[12px] text-text-secondary shrink-0 safe-area-bottom" role="contentinfo">
