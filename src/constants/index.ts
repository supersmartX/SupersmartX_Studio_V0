...
export const PRICING_PLANS = {
  free: {
    ...
    features: [
      ...
      { text: '720p with watermark', highlight: false },
      { text: 'Unlimited local downloads', highlight: true },
    ],
    cta: 'Get Started',
  },
  creator: {
    ...
    features: [
      ...
      { text: 'Voice-activated teleprompter', highlight: false },
      { text: 'Cloud Library', highlight: false },
    ],
    cta: 'Get Creator',
  },
} as const;
...
export const PLATFORM_PRESETS: PlatformPreset[] = [
  ...
  { id: 'instagram-post',    label: 'Instagram Square', sublabel: 'Square · 1:1',     icon: 'IG', color: '#E1306C', category: 'instagram', aspectRatio: '1:1',  width: 1080, height: 1080 },
  { id: 'instagram-portrait',label: 'Instagram Portrait', sublabel: 'Portrait · 4:5',   icon: 'IG', color: '#E1306C', category: 'instagram', aspectRatio: '4:5',  width: 1080, height: 1350 },
